...
![Home question box](screenshots/01-home.png)
...
![Debate Arena](screenshots/20-debate-arena.png)
...
![Education template entry](screenshots/01-home.png)
...
![Simulation Mode](screenshots/01-home.png)
...
![Rounds and Agent sliders](screenshots/01-home.png)
...
![Daily challenge and weekly theme](screenshots/01-home.png)
...
![Prediction verdict](screenshots/02-result.png)
...
![Worldline cards](screenshots/02-result.png)
...
![Next-step entries](screenshots/02-result.png)
...
![Ending Chamber](screenshots/17-ending-chamber.png)
...
![One Move Only](screenshots/17-ending-chamber.png)
...
![Crossline Gallery](screenshots/18-evidence-card.png)
...
![Worldline Roundtable](screenshots/14-roundtable.png)
...
![Roundtable representatives](screenshots/14-roundtable.png)
...
![Roundtable discussion](screenshots/14-roundtable.png)
...
![Deep Dive interview](screenshots/14-roundtable.png)
...
![Research Analyst](screenshots/14-roundtable.png)
...
![Cross-Examine](screenshots/14-roundtable.png)
...
![Evidence Card](screenshots/18-evidence-card.png)
...
![Epilogue](screenshots/19-epilogue.png)
...
![Causal Graph](screenshots/06-causal-map.png)
...
![Graph Workbench](screenshots/07-workbench.png)
...
![Knowledge Graph Explorer](screenshots/08-kg-explorer.png)
...
![Timeline Galaxy](screenshots/09-timeline-galaxy.png)
...
![Counterfactual Compare](screenshots/13-compare.png)
...
Entry: `/replay/:id`
![Replay Trace empty state](screenshots/12-replay.png)
...
![Debate result](screenshots/15-debate.png)
...
Entry: `/agents`
![Agent Identity Library](screenshots/03-agent-library.png)
...
![Custom Agent Workshop](screenshots/04-agent-workshop.png)
...
![Agent Profile Card](screenshots/16-agent-profile.png)
...
![Custom Agent selector](screenshots/01-home.png)
...
![Persona backup](screenshots/03-agent-library.png)
...
Entry: `/me/journal`
![Prediction Journal](screenshots/05-journal.png)
...
![Snapshot import and export](screenshots/02-result.png)
...
![Sharing and prediction card](screenshots/02-result.png)
...
![Search-Augmented Simulation](screenshots/01-home.png)
