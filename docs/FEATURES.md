...
推演模式提供谨慎、均衡、探索三档，只影响主模式的世界线分岔取向。高级设置还可以在 Classic 与 Pixel Theater 之间切换显示；Pixel Theater 用像素舞台展示角色发言、分支和导演工具栏。推演页顶部会用分段进度账条显示当前轮次、进度和预计剩余时间；干预入口只在 live 推演中可用，进入叙事、完成或 replay 后会自动隐藏。导演/玩法卡来自共享契约，当前 14 张为：文明辩论、间谍渗透、密约交易、人类潜入、时空裂缝、民意浪潮、撤离令、公开听证、资源分诊、禁忌仪式、审计清算、情报反噬、授权回摆、停火委员会。Debate Arena 有自己的回合规则，不跟随这个设置。
