...
| `FEATURE_MODEL_PROFILES` | On | The model profile page and `/admin/setup` can manage local profiles; profiles with a key make the home page treat LLM access as configured and can be selected at launch. |
