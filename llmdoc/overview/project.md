...
| Language Switcher (P9) | 全局 EN/ZH 切换器，固定右下角，所有页面可见 |
...
| Reasoning Visualization (Phase 2) | 核心推理可视化 — 天气/昼夜系统 + 阵营标记 + 气泡变体 + 粒子特效；后续语义场景池已在此基础上扩到 26 个背景主题 |
...
| Open Source Polish (Phase 4) | 开源准备 — Weather 粒子对象池 + 视口裁剪 + `ASSET_CREDITS` 现维护 98 张素材清单 |
| i18n | 中英文支持 |
