...
- 本轮修复后复验已通过：
  ...
  - fresh preview 下，`phase3-batch-a full` 和 `phase3-batch-b full` 都 `allPassed=true`；Chromium desktop / mobile 全绿
