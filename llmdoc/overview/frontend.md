...
- 当前真实签收边界：
  ...
  - 当前仍未单独签收的残余：ending-room `replay/share/import` 单链、roundtable mobile 一屏体验、会客厅文案质感
