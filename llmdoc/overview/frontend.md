...
- 当前真实签收边界：
  - 单结局桌面 / 移动端闭环：通过
  - 多结局结果页按各自 ending 打开 picker / chamber / one-move：通过专项 E2E
  - `WorldlineRoundtableView` 的 live / reseat / follow-up / replay readonly：已进入稳定 `release:signoff` 总链并通过
  - 当前仍未单独签收的残余：follow-up 与经典模式的流式一致性、roundtable mobile 一屏体验、roundtable 代表/档案官声线还可继续去模板化
