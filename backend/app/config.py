...
class Settings(BaseSettings):
    ...
    RESULT_VERDICT_REQUEST_TIMEOUT_SECONDS: float = Field(default=45.0, gt=0)
    RESULT_VERDICT_TOTAL_TIMEOUT_SECONDS: float = Field(default=50.0, gt=0)
    NARRATION_REQUEST_TIMEOUT_SECONDS: float = Field(default=35.0, gt=0)
    NARRATION_TOTAL_TIMEOUT_SECONDS: float = Field(default=40.0, gt=0)
    NARRATION_STREAM_PROBE_TIMEOUT_SECONDS: float = Field(default=8.0, gt=0)
