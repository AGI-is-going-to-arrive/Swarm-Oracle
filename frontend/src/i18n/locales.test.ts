...
describe('i18n locale resources', () => {
  ...
  it('keeps the new bridge and graph-guide locale keys present in both English and Chinese resources', () => {
    ...
    const resultFollowupKeys = [
      ...
      'archive_brief_label',
      'archive_lead',
      'archive_question_label',
      'archive_question_unset',
      'archive_verdict_label',
      'archive_verdict_fallback',
      'archive_group_judgement',
      'archive_group_actions',
      'archive_group_next',
      'archive_dominant_branch_hint',
      'archive_dominant_tone_hint',
      'archive_resonance_hint',
      'archive_card_detail',
      'archive_empty_card_hint',
      'archive_bet_detail',
      'archive_empty_bet_hint',
      'archive_commitment_detail_with_round',
      'archive_commitment_detail',
      'archive_empty_commitment_hint',
      'archive_empty_counterplay_hint',
      'archive_empty_goals_hint',
      'archive_empty_signature_hint',
      'archive_empty_system_hint',
      'archive_challenge_feedback_hint',
      'archive_evidence_title',
      'archive_evidence_lead',
      'archive_evidence_counts_label',
      'archive_count_cards',
      'archive_count_bets',
      'archive_count_moments',
      'archive_count_branches',
      'archive_cards_empty',
      'archive_cards_empty_short',
      'archive_bets_empty',
      'archive_bets_empty_short',
      'archive_moments_empty',
      'archive_moments_more',
      'archive_branches_empty',
