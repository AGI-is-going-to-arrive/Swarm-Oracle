...
(function () {
  ...
  var FEATURES = [
    ...
    { id: "F42", img: "25-model-profiles.png", hero: false, zt: "模型配置", et: "Model Profiles",
      zd: "保存多套 LLM 接入信息（服务商、Base URL、模型、密钥、限速）；/admin/setup 测试成功的 profile 会让首页识别为已配置 LLM，并自动带入可用配置。", ed: "Save several LLM setups (provider, base URL, model, key, rate limits); profiles tested from /admin/setup make the home page recognize LLM access as configured and auto-fill an available setup." },
